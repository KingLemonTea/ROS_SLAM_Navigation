...
echo_and_run cd "/home/parallels/turtlebot3/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/parallels/turtlebot3/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/parallels/turtlebot3/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
